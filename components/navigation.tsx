...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 w-full bg-neutral-950/80 backdrop-blur-lg z-50 border-b border-neutral-800/50">
            ...
            <div className="flex flex-col space-y-2 items-center">
              {navItems.map((item) => (
                <Link
                  ...
                  className={cn(
                    "text-neutral-400 hover:text-sky-400 transition-colors py-2 block w-full text-center rounded-md",
                    pathname === item.href ? "bg-neutral-800 text-sky-400" : ""
                  )}
                >
                  {item.name}
